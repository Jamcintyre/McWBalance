...
public class DataTimeIntSeries {
    ...
    private int[] day;
    private int[] value;
    static int MAX_LENGTH = ProjSetting.MAX_LEVELS; // maximum length of DAC that will be accepted,  intention is about 1000 or 1500 to allow for 150 m tall TSF 0.1 m increments. 
    static final int DAY_NULL = -1;
     ...
     * @param inValue 
     */
    DataTimeIntSeries(int inDay[], int inValue[]){
