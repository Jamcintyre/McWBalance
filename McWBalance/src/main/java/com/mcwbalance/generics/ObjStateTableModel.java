...
/**
 * 2D table model, first column is int for days,  second column is String. Assumes ACTIVE as the default state
 * @author amcintyre
 */
public class ObjStateTableModel extends AbstractTableModel{
    /**
     * Column names for this model class are fixed as "Model Day" and "State" modification of these 
