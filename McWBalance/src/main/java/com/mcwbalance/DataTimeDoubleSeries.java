...
public class DataTimeDoubleSeries {
    ...
    static int MAX_LENGTH = ProjSetting.MAX_LEVELS; 
    static final int DAY_NULL = -1;
    static final double VAL_NULL = -9999;
     ...
     * @param nPoints 
     */
    DataTimeDoubleSeries(int nPoints){
     ...
     * @param inValue 
     */
    DataTimeDoubleSeries(int inDay[], double inValue[]){
