...
/**
 * Bin class for misc calculation and debugging methods
 * @author amcintyre
 */
public class CalcBasics {

    /**
     * used for debugging, system outs an array
     *
     * @param array
     */
    ...
    /**
     * Method for identifying which year to assign a numerical day value. Method
     * assumes Day 1 is Jan 1. Method also assumes all years are 365 days, Feb
     * 29 does not exist this may be adjusted later
     *
     * @param day any positive day integer greater then 0;
    ...
    /**
     * Method for rounding to the preferred number of decimals. Method intended
     * to function equal to Excel's round function
     *
     * @param inValue Value to be rounded
     * @param decimals number of decimal places. Note does not handle negitive
     * values yet.
     * @return
     */
